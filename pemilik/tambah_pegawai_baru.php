...
border-bottom: 1px solid grey;"><h4><strong>No ID</strong></h4></td>
                  </tr>
                  <tr>
                      <td style="padding: 5px;
border-bottom: 1px solid grey;"><h4><strong>Nama Depan</strong></h4></td>
                  </tr>
                  <tr>
                      <td style="padding: 5px;
border-bottom: 1px solid grey;"><h4><strong>Nama Belakang</strong></h4></td>
                  </tr>
                  <tr>
                      <td style="padding: 5px;
border-bottom: 1px solid grey;"><h4><strong>Jabatan</strong></h4></td>
                  </tr>
              </tbody>
              </table>
            </div>
            <div class="col-md-6">
              ...
              <tbody>
                  ...
                  <tr>
                      <td><input type="text" class="form-control" id="firstnm">
                      </td>
                  </tr>
                  <tr>
					  <td><input type="text" class="form-control" id="lastnm">
                      </td>
                  </tr>
                  <tr>
                      <td><select class="form-control" id="jbt">
                        <option>Resepsionis</option>
                        <option>Sekuriti</option>
						...
						<option>Petugas room service</option>
                        </select>
                      </td>
                  </tr>
				  <tr>
