...
<h3 style="text-align:center;font-style:italic">Pilih metode pembayaran</h3>
<div id="batang" style="background-color:rgb(51, 51, 51);height:2px;margin: 0px auto;width: 20%;opacity:0.5;"></div>
  <div id="baris_promo" class="row">
	<a href="atm_method.php">
    <div id="kolom_promo" class="col-md-6" style="">
      <img id="foto_promo" src="foto/img-transfer.jpg" style="">
      <div id="tulisan" style="">
        <h3>Transfer via ATM</h3>
        <p>Lakukan pembayaran deposit melalui ATM pilihan Anda dengan praktis dan aman</p>
      </div>
    </div>
	</a>
	<a href="ctr_method.php">
    <div id="kolom_promo" class="col-md-6" style="">
      <img id="foto_promo" src="foto/img-counter.jpg" style="">
      <div id="tulisan" style="">
        <h3>Pembayaran di konter kami</h3>
        <p>Lakukan pembayaran langsung di konter kami dan nikmati pelayanan dan bantuan penuh dari profesional</p>
      </div>
    </div>
	</a>
  </div>
