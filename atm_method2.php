...
<body style="margin:0;font-family:'Roboto', sans-serif;height:100%;overflow-x:hidden;">
  ...
  <div class="container" style="height:auto;">
    <h3 style="text-align:center;">Petunjuk Pembayaran melalui ATM</h3>
    ...
    <div class="row">
              <ol type="1">
				<li>Untuk bank <b>Mandiri</b>, transfer biaya deposit ke nomor rekening Mandiri <b>101-517874-491-4</b> cabang ITS a/n PT WISHMILAK</li><br>
				<li>Untuk bank <b>BNI</b>, transfer biaya deposit ke nomor rekening BNI <b>115-888571-774</b> cabang Ngaggel a/n PT WISHMILAK</li><br>
				<li>Untuk bank <b>BCA</b>, transfer biaya deposit ke nomor rekening BCA <b>478-555-55665</b> cabang Kertajaya a/n PT WISHMILAK</li><br>
				<li>Transfer sesuai dengan biaya deposit yang sudah ditampilkan. <i>Jumlah biaya deposit Anda sebesar <b>Rp357.500,00</b></i></li><br>
				<li>Gunakan ID transaksi sebagai nomor referensi pada proses transfer. <i>ID transaksi Anda adalah <b>75886542</b></i></li><br>
				<li><b>Simpan bukti transfer Anda.</b> Ambil foto atau scan bukti transfer Anda untuk proses validasi.</li><br>
			  </ol>
    ...
    <div class="row" style="margin-bottom:2%;">
      <div class="col-md-12" style="width:100%;">
		...
		<a href="validate_transfer2.1.php">
        <button type="button" class="btn btn-danger" style="margin: 0px auto;">Saya sudah transfer</button>
		</a>
        </div>
      </div>
    </div>	
