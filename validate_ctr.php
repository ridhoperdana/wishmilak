...
<body style="margin:0;font-family:'Roboto', sans-serif;height:100%;overflow-x:hidden;">
  ...
  <div class="container" style="height:auto;">
    <h3 style="text-align:center;">Masukkan ID Transaksi Anda</h3>
	...
	<i>Masukkan ID transaksi yang tercetak pada nota pembayaran Anda</i><br><br>
	<input type="text" class="form-control" id="usr"><br>
  <a href="validate_transfer2.php">
        <button type="button" class="btn btn-danger" style="margin: 0px auto;">Submit</button>
		</a>
</form>
