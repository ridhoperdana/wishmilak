...
border-bottom: 1px solid grey;"><h4><strong>Wisma</strong></h4></td>
                  </tr>
                  <tr>
                      <td style="padding: 5px;
border-bottom: 1px solid grey;"><h4><strong>Kamar</strong></h4></td>
                  </tr>
                  <tr>
                      <td style="padding: 8px;
border-bottom: 1px solid grey;"><h4><strong>Jumlah Kosong</strong></h4></td>
                  </tr>
                  <tr>
                      <td style="padding: 8px;
border-bottom: 1px solid grey;"><h4><strong>Jumlah Isi</strong></h4></td>
                  </tr>
                  <tr>
                      <td style="padding: 5px;"><h4><strong>Fasilitas</strong></h4></td>
                  </tr>
              </tbody>
              </table>
            </div>
            <div class="col-md-6">
              ...
              <tbody>
                  ...
                  <tr>
                      <td>
                        <div id="" style="height: 120px;overflow-y: auto;">
                            <ul>
                              <li>Kamar</li>
                              <li>Kamar</li>
                              <li>Kamar</li>
