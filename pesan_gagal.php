...
<body style="margin:0;font-family:'Roboto', sans-serif;height:100%;overflow-x:hidden;">
  ...
  <div class="container" style="height:auto;">
    ...
    <div class="row" style="margin-bottom:5%;">
      ...
      <div class="col-md-12">
        <div style="background-color:rgb(244, 67, 54);padding: 5%;margin:0 auto;text-align:center;width:50%;">
          <h4 style="margin-bottom:5%;">Kamar tidak tersedia, berikut rekomendasi kamar yang kami sediakan:</h4>
          <form role="form" style="">
            <div style="width: 100%;">
			         <div class="form-group">
                <label for="sel2" style="color:white;">Nama Wisma:</label>
                  <select class="form-control" id="sel1">
                    <option>Flamboyan</option>
                    <option>Bougenvil</option>
